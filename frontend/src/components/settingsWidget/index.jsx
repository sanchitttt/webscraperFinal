...
function SettingsModal({ showSettings, setShowSettings, showFilters, setShowFilters }) {
    ...
    return (
        <div
            ...
            className={`${showSettings ? "w-[350px]" : "w-[0px]"} p-[20px] bg-white rounded-tl-[20px] rounded-bl-[20px] top-[200px] fixed right-[0px] z-[1000] shadow-v6 ${themeValue === 'dark' ? "bg-[#333]" : "bg-white"}`}>
